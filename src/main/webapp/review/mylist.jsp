            ...
            <table border="1" id="f">
                ...
                <c:if test="${not empty r.img1}">
                    <div class="mb-3 row">
                        ...
                        <img src="${r.img1}" style="width: 100px; height: 100px;" class="img-thumbnail" id="img1">
                        <c:if test="${not empty r.img2}">
                            <img src="${r.img2}" style="width: 100px; height: 100px;" class="img-thumbnail" id="img2">
                        </c:if>
                        <c:if test="${not empty r.img3}">
                            <img src="${r.img3}" style="width: 100px; height: 100px;" class="img-thumbnail" id="img3">
                        </c:if>
                    </div>
                </c:if>
